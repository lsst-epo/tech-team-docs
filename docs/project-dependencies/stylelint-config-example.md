[StyleLint](https://stylelint.io/) helps you keep your styles in check: property orders, nesting, whitespace, etc.

A StyleLint config lives in the root of your project and is named `.stylelintrc.js`.

A config for a project using Scss:
